...
This template is not providing the PIP on nic0. If you don't have VGW or Express Route, you will need to create PIP and attath it to the management interface of VM to access it.